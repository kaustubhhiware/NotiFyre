...
Notifyre has been tested on a fresh install of Ubuntu and Mac running bash, zsh or fish. If you have managed to port this script to another shell or another OS, please open a pull request with the instructions for the same and we will update the README! Featured by [ostechnix](https://www.ostechnix.com/get-notification-terminal-task-done/).
...
- [NotiFyre](#notifyre)
  ...
  - [Debugging](#debugging)
    - [Message not displayed (Mac)](#message-not-displayed-mac)
    - [Message not displayed (ubuntu)](#message-not-displayed-ubuntu)
...
Tested on Ubuntu, Arch Linux and Mac. Ubuntu may require [Slick.ogg](Slick.ogg) whose path must be changed before usage.
...
### Message not displayed (Mac)

Make sure that notifications are allowed in System Settings -> Notifications -> Your Terminal, and terminal-notifier.

### Message not displayed (ubuntu)
